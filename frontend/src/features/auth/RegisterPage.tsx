  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-2">Tạo tài khoản mới</h1>
        <p className="text-center text-gray-500 mb-6">Tham gia cùng cộng đồng mạng xã hội!</p>
