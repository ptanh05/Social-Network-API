...
router.get('/users/:id/followers', withAuth(async (req: AuthRequest, res: Response) => {
...
router.get('/users/:id/following', withAuth(async (req: AuthRequest, res: Response) => {
  const userId = paramId(req, 'id');
  const cursor = safeCursor(req);
  const limit = safeLimit(req);
...
router.get('/users/:id/status', withAuth(async (req: AuthRequest, res: Response) => {
  const u = getUser(req);
...
router.post('/users/:id/follow', withAuth(async (req: AuthRequest, res: Response) => {
...
router.delete('/users/:id/follow', withAuth(async (req: AuthRequest, res: Response) => {
  const u = getUser(req);
